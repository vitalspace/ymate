...
<svelte:head>
   ...
   <script async src="http://arc.io/widget.min.js#FSBSx97R"></script>
    ...
    <!-- elements go here -->
    <title
        >Ymate.tools - You Tube Downloader - SoundCloud Downloader - Video and
    ...
    <div class="m-auto mt-6 w-full border-2 shadow-lg sm:w-full lg:w-3/5">
        <div class="py-5 px-4 text-center">
            <h2 class="font-bold text-4xl">
                Download audio files from <a href="/" class="text-orange-400"
                    >Soundcloud,</a
                > Convert, Download music from Soundcloud to MP3 quickly.
            </h2>
