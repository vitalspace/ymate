...
<svelte:head>
    ...
    <meta
        name="description"
        content="ymate.tools is a website to download audio files from SoundCloud, download music from SoundCloud Ymate.tools Downloader, Convert Soundcloud to mp3, convert online free"
    />
    ...
    <meta
        itemprop="name"
        content="Download Audio from SoundCloud"
    /><meta
  ...
  <div>
    <div class="m-auto mt-6 w-full border-2 shadow-lg sm:w-full lg:w-3/5">
        <div class="py-5 px-4 text-center">
            <h2 class="font-bold text-4xl">
              Download audio files from <a href="/" class="text-orange-400">Soundcloud,</a> Convert,
              Download music from Soundcloud to MP3 quickly.
            </h2>
    ...
    >
        ...
        <p class="py-2 text-gray-500">
            ...
            supports the download all video formats like: MP4, M4V, 3GP, WMV,
            FLV, MO, MP3, WEBM, etc You can download videos from Youtube, easily
            in a free from <a class="text-green-500" href="/">Ymate.tools</a>.
        </p>
    </div>
