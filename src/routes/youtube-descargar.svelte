<script>
  ...
  <svelte:head>
    ...
    <meta
        name="description"
        content="ymate.tools es un sitio web para descargar videos de Youtube, descargar música de youtube Y2meta Downloader, convertir youtube a mp3, convertir youtube a mp4 en línea gratis"
    />
    ...
    <meta
        itemprop="name"
        content="Descargar video y audio de YouTube"
    /><meta
    ...
    <div class="m-auto mt-6 w-full border-2 shadow-lg sm:w-full lg:w-3/5">
      <div class="py-5 px-4 text-center">
        <h2 class="font-bold text-4xl">
          Descargue videos de <a href="/" class="text-red-400">Youtube,</a> Convierta,
          Descarge musica de Youtube a MP3 rápidamente.
        </h2>
